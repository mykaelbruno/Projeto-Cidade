...
public record SinalizacaoDenunciaResponseDTO(
		...
		Long comentarioId,
		String comentarioSinalizadoConteudo,
		Long autorId,
		String autorNome,
	...
	public static SinalizacaoDenunciaResponseDTO from(SinalizacaoDenuncia sinalizacao) {
		return new SinalizacaoDenunciaResponseDTO(
				...
				sinalizacao.getComentarioSinalizado() == null ? null : sinalizacao.getComentarioSinalizado().getId(),
				sinalizacao.getComentarioSinalizado() == null ? null : sinalizacao.getComentarioSinalizado().getConteudo(),
