...
- Fase 31: Refinados os fluxos do morador a partir do QA manual: criacao de relato com mapa funcional por geocodificacao e localizacao atual, cidade fixa da conta, revisao com previews, retorno ao feed com modal de sucesso, carrossel de imagens no detalhe, sino de notificacoes com estado real, perfil refeito com dados reais e mapa da cidade com pinos clicaveis e card acompanhando o movimento.
- Fase 32: Refinados os fluxos da prefeitura e da administracao local: remocao de elementos de prototipo, busca operacional aplicada sob demanda, bloqueio de arquivamento fora da moderacao, resposta oficial e acoes horizontais na pagina do relato, timeline com status formatados, operadores institucionais reais na administracao, gestao de bairros com mapa/localizacao/endereco e nova aba de auditoria especifica da prefeitura.
