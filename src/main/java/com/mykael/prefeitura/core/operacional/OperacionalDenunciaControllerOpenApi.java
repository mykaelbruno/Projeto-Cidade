...
public interface OperacionalDenunciaControllerOpenApi {
	...
	@Operation(
			...
			Permite filtrar por cidade, bairro, status, categoria, organizacao responsavel e termo textual para apoiar os paineis do frontend.
			"""
	)
	...
	Page<DenunciaResponseDTO> listarDenunciasDaOrganizacao(
			...
			@Parameter(description = "Identificador da secretaria responsavel quando a consulta for feita por prefeitura.", in = ParameterIn.QUERY) Long organizacaoResponsavelId,
